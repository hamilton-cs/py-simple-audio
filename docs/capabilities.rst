...
simpleaudiohamiltoncs supports standard integer 8-, 16-, and 24-bit integer formats, as well as 32-bit floating point.
...
audio library for Python. While it has more capability than simpleaudiohamiltoncs,
...
installation. simpleaudiohamiltoncs is intended to be one-stop shopping for a
