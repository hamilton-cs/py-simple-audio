...
:mod:`simpleaudiohamiltoncs.functionchecks`
=================================

.. module:: simpleaudiohamiltoncs.functionchecks
   :synopsis: Provides tests of functionality by playing various test audio clips.

The :mod:`~simpleaudiohamiltoncs.functionchecks` module contains a number of classes 
